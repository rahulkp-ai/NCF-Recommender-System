...
def client():
    ...
    with patch("production.backend.app.db.seed.run_seed", return_value=None), \
        ...
        mock_svc.recommend_homepage.return_value = {
            "strategy": "cold_start",
            "recommendations": [
                {"item_id": 1, "score": 0.9, "source": "cold_start", "alpha": 0.0,
                 "title": "Toy Story (1995)", "genres": "Animation|Comedy",
                 "poster_url": None, "year": 1995}
            ],
        }
        mock_svc.recommend_for_user.return_value = {
            "user_id": 1, "n_interactions": 5, "alpha": 0.25,
            "strategy": "blend",
            "recommendations": [
                {"item_id": 2, "score": 0.8, "source": "blend", "alpha": 0.25,
                 "title": "GoodFellas (1990)", "genres": "Crime|Drama",
                 "poster_url": None, "year": 1990}
            ],
        }
